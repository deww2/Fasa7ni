...
<form onsubmit="validateForm()" method="post" action="PyramidRegsitration.php">
  <div class="containerrr">
    <h1>Register your Pyramid Ticket</h1>
    <p>Please fill in this form to register your Tour.</p>
    <hr>
...
<br><br>
    ...
    <label for="loc"><b>Ticket Price's</b></label>
    <select id="loc" name="loc">
      <option value="150LE">150LE</option>
      <option value="250LE">250LE</option>
      <option value="350LE">350LE</option>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      switch ($action) {
        case 'submit':
          ...
          $sqlCheck = "SELECT * FROM pyramid WHERE email=?";
          ...
          if ($result->num_rows > 0) {
            ...
            $sqlInsert = "INSERT INTO pyramid (name, email, phonenum, dt, time, loc) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        case 'update':
          // Update logic
          $sqlUpdate = "UPDATE pyramid SET name=?, phonenum=?, dt=?, time=?, loc=? WHERE email=?";
        ...
        case 'delete':
          // Delete logic
          $sqlDelete = "DELETE FROM pyramid WHERE email=?";
