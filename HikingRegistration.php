HikingRegistration:<!DOCTYPE html>
<html>
...
<body class="body3">
  <div class="background-wrapper">
    ...
    <form onsubmit="validateForm()" method="post" action="HikingRegistration.php">
      <div class="containerrr">


        <h1>Register your Hiking Trial</h1>
        ...
        <select id="loc" name="loc">
          <option value="SinaiTrial">Sinai Trail</option>
          <option value="MT.catherine">Mt. Catherine</option>
          <option value="JebelSerbal">Jebel Serbal</option>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      switch ($action) {
        case 'submit':
          ...
          $sqlCheck = "SELECT * FROM hiking WHERE email=?";
          ...
          if ($result->num_rows > 0) {
            ...
            $sqlInsert = "INSERT INTO hiking (name, email, phonenum, dt, time, loc) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        case 'update':
          // Update logic
          $sqlUpdate = "UPDATE hiking SET name=?, phonenum=?, dt=?, time=?, loc=? WHERE email=?";
        ...
        case 'delete':
          // Delete logic
          $sqlDelete = "DELETE FROM hiking WHERE email=?";
